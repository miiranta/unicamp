"""GELU204 – Sparse Top-K=8 Signed Gate (K ablation: 0.5x gelu189).

Identical to gelu189 but K=8. Tests whether ultra-sparse (0.78% of D=1024)
is even better, or if K=16 already undershoots optimal coverage.
...
class GELU204(nn.Module):
    """Sparse top-K=8 signed gate (K ablation: 0.5x gelu189)."""
